...
class HealthFragment : Fragment() {
    ...
    private fun setGraphValue(bmiList: List<BMIDataItem?>?) {
        ...
        val limitLine3 = LimitLine(limit3, "")
        limitLine3.lineWidth = 1f
        limitLine3.lineColor = 0xFFFF0000.toInt() // Red color
        limitLine3.lineWidth = 2f
        ...
        legend.textColor = if (AppCompatDelegate.getDefaultNightMode() == AppCompatDelegate.MODE_NIGHT_YES) {
            Color.WHITE
        } else {
            Color.BLACK
        }
        ...
        legendEntries.add(LegendEntry("UnderWeight", Legend.LegendForm.LINE, 10f, 2f, null, 0xFF00FF00.toInt()))
        legendEntries.add(LegendEntry("OverWeight", Legend.LegendForm.LINE, 10f, 2f, null, 0xFFFFFF00.toInt()))
        legendEntries.add(LegendEntry("Obesse", Legend.LegendForm.LINE, 10f, 2f, null, 0xFFFF0000.toInt()))
