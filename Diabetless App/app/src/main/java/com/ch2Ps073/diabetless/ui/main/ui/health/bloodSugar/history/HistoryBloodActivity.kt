...
class HistoryBloodActivity : AppCompatActivity() {
    ...
    private fun setGraphValue(bmiList: List<BloodSugarDataItem?>?) {
        ...
        limitLine2.lineColor = 0xFFFF0000.toInt() // Red color
        ...
        legendEntries.add(LegendEntry("Normal", Legend.LegendForm.LINE, 10f, 2f, null, 0xFF00FF00.toInt()))
        legendEntries.add(LegendEntry("High", Legend.LegendForm.LINE, 10f, 2f, null, 0xFFFFFF00.toInt()))
